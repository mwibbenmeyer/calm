...
use "processing\combined\combined_ccp_returns.dta", clear

destring weighted_ccp other_nr, replace ignore("NA")
...
replace y_dy = . if initial_acres == 0 | initial_acres == .
replace y_st = . if initial_acres == 0 | initial_acres == .

mvpatterns forest_nr urban_nr other_nr crop_nr y_st lcc
...
foreach use in crop forest other urban {
	forvalues i = 0/4 {
