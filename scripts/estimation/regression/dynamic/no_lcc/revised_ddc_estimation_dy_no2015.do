...
capture mkdir `dir'
log using "`dir'regs_2022-03-29_unweighted_dy_no2015.log", replace
capture rm "`dir'regs_2022-03-29_unweighted_dy_no2015.xls" 
capture rm "`dir'regs_2022-03-29_unweighted_dy_no2015.txt"
capture rm "`dir'regs_2022-03-29_unweighted_3digits_dy_no2015.xls"
capture rm "`dir'regs_2022-03-29_unweighted_3digits_dy_no2015.txt"
...
outreg2 using "`dir'regs_2022-03-29_unweighted_dy_no2015.xls", e(r2_a) stats(coef se) bdec(10) ///
addtext(weights, NO) append
outreg2 using "`dir'regs_2022-03-29_unweighted_3digits_dy_no2015.xls", e(r2_a) stats(coef se) bdec(3) ///
addtext(weights, NO) append
