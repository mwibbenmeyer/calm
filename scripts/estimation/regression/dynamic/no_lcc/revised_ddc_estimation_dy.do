...
capture mkdir `dir'
log using "`dir'regs_2022-02-04_unweighted_dy.log", replace
capture rm "`dir'regs_2022-02-04_unweighted_dy.xls" 
capture rm "`dir'regs_2022-02-04_unweighted_dy.txt"
capture rm "`dir'regs_2022-02-04_unweighted_3digits_dy.xls"
capture rm "`dir'regs_2022-02-04_unweighted_3digits_dy.txt"
...
outreg2 using "`dir'regs_2022-02-04_unweighted_dy.xls", e(r2_a) stats(coef se) bdec(10) ///
addtext(weights, NO) append
outreg2 using "`dir'regs_2022-02-04_unweighted_3digits_dy.xls", e(r2_a) stats(coef se) bdec(3) ///
addtext(weights, NO) append
