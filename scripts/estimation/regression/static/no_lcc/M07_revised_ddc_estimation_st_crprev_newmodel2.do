...
est save "`dir'regs_2022-07-12_nolcc_st_newmodel2.est", replace
outreg2 using "`dir'regs_2022-07-12_nolcc_3digits_st_newmodel2.xls", e(r2_a) stats(coef se) bdec(3) ///
...
est save "`dir'regs_2022-07-12_lcc_st_newmodel2.est", replace
outreg2 using "`dir'regs_2022-07-12_lcc_3digits_st_newmodel2.xls", e(r2_a) stats(coef se) bdec(3) ///
