...
capture mkdir `dir'
capture rm "`dir'regs_2022-06-21_nolcc_st_se.xls" 
capture rm "`dir'regs_2022-06-21_nolcc_st_se.txt"
capture rm "`dir'regs_2022-06-21_nolcc_3digits_st_se.xls"
capture rm "`dir'regs_2022-06-21_nolcc_3digits_st_se.txt"
...
est save "`dir'regs_2022-06-21_nolcc_st_se.est", replace
outreg2 using "`dir'regs_2022-06-21_nolcc_st_se.xls", e(r2_a) stats(coef se) bdec(10) ///
addtext(weights, NO) append
outreg2 using "`dir'regs_2022-06-21_nolcc_3digits_st_se.xls", e(r2_a) stats(coef se) bdec(3) ///
addtext(weights, NO) append
...
local dir "results\initial_estimation\regs_2022-06\"
capture mkdir `dir'
capture rm "`dir'regs_2022-06-21_lcc_st_se.xls" 
capture rm "`dir'regs_2022-06-21_lcc_st_se.txt"
capture rm "`dir'regs_2022-06-21_lcc_3digits_st_se.xls"
capture rm "`dir'regs_2022-06-21_lcc_3digits_st_se.txt"
...
est save "`dir'regs_2022-06-21_lcc_st_se.est", replace
outreg2 using "`dir'regs_2022-06-21_lcc_st_se.xls", e(r2_a) stats(coef se) bdec(10) ///
addtext(weights, NO, eta, transitionxLCC, theta, landusexLCC) append
outreg2 using "`dir'regs_2022-06-21_lcc_3digits_st_se.xls", e(r2_a) stats(coef se) bdec(3) ///
addtext(weights, NO, eta, transitionxLCC, theta, landusexLCC) append
