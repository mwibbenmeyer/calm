...
capture mkdir `dir'
// log using "`dir'regs_2022-05-04_unweighted_lcc_st.log", replace
capture rm "`dir'regs_2022-05-04_lcc_st_newspec_fullsample.xls" 
capture rm "`dir'regs_2022-05-04_lcc_st_newspec_fullsample.txt"
capture rm "`dir'regs_2022-05-04_lcc_3digits_st_newspec_fullsample.xls"
capture rm "`dir'regs_2022-05-04_lcc_3digits_st_newspec_fullsample.txt"
...
est save "`dir'regs_2022-05-04_unweighted_lcc_st1_fullsample.est", replace
outreg2 using "`dir'regs_2022-05-04_lcc_st_newspec_fullsample.xls", e(r2_a) stats(coef se) bdec(10) ///
addtext(weights, NO, eta, transitionxLCC, theta, landusexLCC) append
outreg2 using "`dir'regs_2022-05-04_lcc_3digits_st_newspec_fullsample.xls", e(r2_a) stats(coef se) bdec(3) ///
addtext(weights, NO, eta, transitionxLCC, theta, landusexLCC) append
...
est save "`dir'regs_2022-05-04_unweighted_lcc_st2_fullsample.est", replace
outreg2 using "`dir'regs_2022-05-04_lcc_st_newspec_fullsample.xls", e(r2_a) stats(coef se) bdec(10) ///
...
est save "`dir'regs_2022-05-04_unweighted_lcc_st3_fullsample.est", replace
outreg2 using "`dir'regs_2022-05-04_lcc_st_newspec_fullsample.xls", e(r2_a) stats(coef se) bdec(10) ///
...
est save "`dir'regs_2022-05-04_unweighted_lcc_st4_fullsample.est", replace
outreg2 using "`dir'regs_2022-05-04_lcc_st_newspec_fullsample.xls", e(r2_a) stats(coef se) bdec(10) ///
...
est save "`dir'regs_2022-05-04_unweighted_lcc_st5_fullsample.est", replace
outreg2 using "`dir'regs_2022-05-04_lcc_st_newspec_fullsample.xls", e(r2_a) stats(coef se) bdec(10) ///
...
est save "`dir'regs_2022-05-04_unweighted_lcc_st6_fullsample.est", replace
outreg2 using "`dir'regs_2022-05-04_lcc_st_newspec_fullsample.xls", e(r2_a) stats(coef se) bdec(10) ///
