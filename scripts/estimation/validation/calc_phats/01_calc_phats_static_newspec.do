...
est use "`dir'regs_2022-04-27_unweighted_lcc_st1.est"
est replay
...
* Save results
preserve
local dir "processing\regressions\predicted_probs\"
keep fips year initial_use final_use lcc initial_acres final_acres  *_nr weighted_ccp phat
export delimited "`dir'preds_2022-04-27_lcc_st_newspec1.csv", replace
restore

/* Specification 3 */
local dir "results\initial_estimation\regs_2022-04\"
est use "`dir'regs_2022-04-27_unweighted_lcc_st3.est"
est replay
...
local dir "processing\regressions\predicted_probs\"
keep fips year initial_use final_use lcc initial_acres final_acres  *_nr weighted_ccp phat
export delimited "`dir'preds_2022-04-27_lcc_st_newspec3.csv", replace
restore

/* Specification 5 */
local dir "results\initial_estimation\regs_2022-04\"
est use "`dir'regs_2022-04-27_unweighted_lcc_st5.est"
est replay
...
local dir "processing\regressions\predicted_probs\"
keep fips year initial_use final_use lcc initial_acres final_acres  *_nr weighted_ccp phat
export delimited "`dir'preds_2022-04-27_lcc_st_newspec5.csv", replace
restore
