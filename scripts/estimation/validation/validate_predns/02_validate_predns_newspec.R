...
df <- read.csv("processing/simulation/predicted_probs/preds_2022-04-27_lcc_st_newspec1.csv") %>% 
...
make_density("Crop","CRP", ub = 0.0005, lb = 0)
...
make_scatter("Forest","Forest",year =  2002, zoom = TRUE)
make_scatter("Crop","CRP",year =  2002, zoom = TRUE)
