...
df <- read.csv("results/initial_estimation/regs_2022-07/preds_2022-07-12_nolcc_st_replace_urban.csv") %>% 
...
make_density("Forest","Forest", ub = 1, lb = 0.999)
make_density("Crop","Crop", ub = 1, lb = 0.95)
make_density("Forest","Other", ub = 0.0005, lb = 0)
make_density("Crop","Other", ub = 0.05, lb = 0)

make_density("Crop","Urban", ub = 0.0005, lb = 0)
make_density("Forest","Urban", ub = 0.0005, lb = 0)
make_density("Other","Urban", ub = 0.0005, lb = 0)
...
make_scatter("Forest","Other",year =  2002, zoom = FALSE)
make_scatter("Crop","Other",year =  2002, zoom = FALSE)
make_scatter("Crop","Urban",year =  2002, zoom =FALSE)
make_scatter("Forest","Urban",year =  2002, zoom =FALSE)
make_scatter("Other","Urban",year =  2002, zoom =FALSE)
...
p <- make_scatter("Forest","Forest",year =  2002, zoom = TRUE)
p
