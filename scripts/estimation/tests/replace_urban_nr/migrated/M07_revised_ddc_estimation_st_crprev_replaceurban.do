...
use "processing\combined\ddc_data_urbancal_crprev_urbannrsub", clear
...
//drop great plains test
//drop if inlist(stateabbrev,"ND", "SD", "MT", "NE", "KS", "WY")
...
capture mkdir `dir'
capture rm "`dir'regs_2022-07-12_nolcc_3digits_st_newmodel1.xls"
capture rm "`dir'regs_2022-07-12_nolcc_3digits_st_newmodel1.txt"
...
est save "`dir'regs_2022-07-12_nolcc_st_replace_urban.est", replace
outreg2 using "`dir'regs_2022-07-12_nolcc_3digits_st_replace_urban.xls", e(r2_a) stats(coef se) bdec(3) ///
...
local dir "results\initial_estimation\regs_2022-07\"
capture mkdir `dir'
capture rm "`dir'regs_2022-07-12_lcc_3digits_st_newmodel1.xls"
capture rm "`dir'regs_2022-07-12_lcc_3digits_st_newmodel1.txt"
...
est save "`dir'regs_2022-07-12_lcc_st_replace_urban.est", replace
outreg2 using "`dir'regs_2022-07-12_lcc_3digits_st_replace_urban.xls", e(r2_a) stats(coef se) bdec(3) ///
