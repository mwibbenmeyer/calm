...
use "processing\combined\ddc_data_urbancal_crprev_urbannrsub_daveforestnr", clear
...
est save "`dir'regs_2022-07-12_nolcc_st_replace_urban_daveforestnr.est", replace
outreg2 using "`dir'regs_2022-07-12_nolcc_3digits_st_replace_urban_daveforestnr.xls", e(r2_a) stats(coef se) bdec(3) ///
...
est save "`dir'regs_2022-07-12_lcc_st_replace_urban_daveforestnr.est", replace
outreg2 using "`dir'regs_2022-07-12_lcc_3digits_st_replace_urban_daveforestnr.xls", e(r2_a) stats(coef se) bdec(3) ///
