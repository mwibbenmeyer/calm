...
source("scripts/estimation/tests/data_from_dave/007_simulation/007-00_fn_modify_returns.R")
...
simulate_luc <- function(returns, estimates) {
  ...
  qui do "scripts/estimation/tests/data_from_dave/007_simulation/007-00_program_calc_phats.do"
...
est <- "results/initial_estimation/regs_2022-05/regs_2022-05-19_unweighted_nolcc_st_southeast_olddata.est"
