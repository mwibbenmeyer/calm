...
merge 1:1 fips year initial_use lcc using "processing\elasticity\lcc_static_all\implied_prob_lcc_static.dta"
keep if year == 2015
...
foreach k in urban crp crop forest other {
	...
	merge 1:1 fips year initial_use lcc using "processing\elasticity\lcc_static_all\implied_prob_lcc_static_`k'10pct.dta"
	keep if year == 2015
...
putexcel set processing\elasticity\lcc_static_all\final_acres_lcc_static, replace
putexcel A2 = "Urban"
putexcel A3 = "CRP"
putexcel A4 = "Crop"
putexcel A5 = "Forest"
