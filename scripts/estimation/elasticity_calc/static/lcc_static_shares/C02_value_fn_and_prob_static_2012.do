...
import delimited "results\initial_estimation\regs_2022-02\regs_2022-02-04_unweighted_lcc_st.txt", varnames(2) 
keep if variables != "" & y != ""
...
/* Calculate probabilities for 2012 only */
keep if year==2012
...
forvalues j = 1/5 {	
	...
	by fips: replace vcond`j' = eta_`j' + theta_`j'*P_`j'
...
putexcel set processing\elasticity\lcc_static_shares\st_prob_lcc_shares_2012, replace
putexcel A2 = "Urban"
putexcel A3 = "CRP"
putexcel A4 = "Crop"
putexcel A5 = "Forest"
...
putexcel set processing\elasticity\lcc_static_shares\st_prob_lcc`num'_shares_2012, replace
putexcel A2 = "Urban"
putexcel A3 = "CRP"
putexcel A4 = "Crop"
putexcel A5 = "Forest"
...
save "processing\elasticity\lcc_static_shares\implied_prob_static_lcc_shares_2012.dta", replace
