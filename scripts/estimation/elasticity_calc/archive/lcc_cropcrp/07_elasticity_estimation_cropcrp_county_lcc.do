...
/*** GET INITIAL ACRES ***/
import delimited "processing\elasticity\initial_acres_county_lcc.csv"


/******************* ORIGINAL EQUILIBRIUM ***************************/
/*** GET PROBABILITY ESTIMATES ***/
merge 1:1 fips year lcc initial_use using "processing\elasticity\lcc_cropcrp\implied_prob_cropcrp_lcc.dta"
keep if year == 2015
keep year fips lcc initial_use initial_acres p1 p2
...
foreach k in crop crp {
	...
	keep year fips lcc initial_use initial_acres acres_*

	merge 1:1 fips year lcc initial_use using "processing\elasticity\lcc_cropcrp\implied_prob_cropcrp_`k'10pct_lcc.dta"
	keep if year == 2015
	keep year fips lcc initial_use initial_acres acres_* p1 p2
