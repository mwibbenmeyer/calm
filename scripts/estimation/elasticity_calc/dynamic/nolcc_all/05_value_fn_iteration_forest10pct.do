...
import delimited "results\initial_estimation\regs_2022-02\regs_2022-02-04_unweighted_dy.txt", varnames(2) 
keep if variables != "" & y != ""
...
putexcel set processing\elasticity\nolcc_all\dy_prob_forest10pct, replace
putexcel A2 = "Urban"
putexcel A3 = "CRP"
putexcel A4 = "Crop"
putexcel A5 = "Forest"
...
save "processing\elasticity\nolcc_all\implied_prob_forest10pct.dta", replace
