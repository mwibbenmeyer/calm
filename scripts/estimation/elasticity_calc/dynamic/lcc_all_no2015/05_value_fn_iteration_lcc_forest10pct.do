...
import delimited "results\initial_estimation\regs_2022-03\regs_2022-03-29_unweighted_lcc_dy_no2015.txt", varnames(2) 
keep if variables != "" & y != ""
		...
		foreach j in $land_use {
			if "`k'" != "`j'" {
				...
				di "`k'to`j'"
 				...
 				local eta_`k'to`j'_`lcc' = r(mean)/(1-$beta)
...
/*** INCREASE FOREST RENTS BY 10% ***/
replace forest_nr = forest_nr*1.1
...
putexcel set processing\elasticity\lcc_all_no2015\dy_prob_lcc_forest10pct, replace
putexcel A2 = "Urban"
putexcel A3 = "CRP"
putexcel A4 = "Crop"
putexcel A5 = "Forest"
...
putexcel set processing\elasticity\lcc_all_no2015\dy_prob_lcc`num'_forest10pct, replace
putexcel A2 = "Urban"
putexcel A3 = "CRP"
putexcel A4 = "Crop"
putexcel A5 = "Forest"
...
save "processing\elasticity\lcc_all_no2015\implied_prob_lcc_forest10pct.dta", replace
