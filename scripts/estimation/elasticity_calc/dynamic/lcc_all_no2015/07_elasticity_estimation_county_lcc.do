...
merge 1:1 fips year initial_use lcc using "processing\elasticity\lcc_all_no2015\implied_prob_lcc.dta"
keep if year == 2015
...
foreach k in urban crp crop forest other {
	...
	merge 1:1 fips year initial_use lcc using "processing\elasticity\lcc_all_no2015\implied_prob_lcc_`k'10pct.dta"
	keep if year == 2015
...
putexcel set processing\elasticity\lcc_all_no2015\final_acres_lcc, replace
putexcel A2 = "Urban"
putexcel A3 = "CRP"
putexcel A4 = "Crop"
putexcel A5 = "Forest"
