		...
		foreach j in $land_use {
			if "`k'" != "`j'" {
				...
				di "`k'to`j'"
 				...
 				local eta_`k'to`j'_`lcc' = r(mean)/(1-$beta) /* Divide by 1-beta to recover structural parameter*/
...
putexcel set processing\elasticity\lcc_all_no2015\dy_prob_lcc, replace
putexcel A2 = "Urban"
putexcel A3 = "CRP"
putexcel A4 = "Crop"
putexcel A5 = "Forest"
...
putexcel set processing\elasticity\lcc_all_no2015\dy_prob_lcc`num', replace
putexcel A2 = "Urban"
putexcel A3 = "CRP"
putexcel A4 = "Crop"
putexcel A5 = "Forest"
...
save "processing\elasticity\lcc_all_no2015\implied_prob_lcc.dta", replace
