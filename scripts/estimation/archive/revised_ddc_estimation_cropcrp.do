...
capture mkdir `dir'
log using "`dir'regs_2021-10-29_unweighted_cropcrp.log", replace
...
reg y c.CRP_nr#c.dCRP c.crop_nr#c.dCrop `r(varlist)', robust cluster(fips)
outreg2 using "`dir'regs_2021-10-29_unweighted_cropcrp.xls", e(r2_a) stats(coef se) bdec(8) ///
