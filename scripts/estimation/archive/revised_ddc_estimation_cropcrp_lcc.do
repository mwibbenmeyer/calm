...
capture mkdir `dir'
log using "`dir'regs_2021-12-01_unweighted_cropcrp_lcc.log", replace
...
reg y c.CRP_nr#c.dCRP c.crop_nr#c.dCrop `r(varlist)' ///
c.lcc2#c.CRPtoCrop c.lcc3#c.CRPtoCrop c.lcc4#c.CRPtoCrop ///
c.lcc2#c.CroptoCRP c.lcc3#c.CroptoCRP c.lcc4#c.CroptoCRP ///
c.cropXlcc2#c.dCrop c.cropXlcc3#c.dCrop c.cropXlcc4#c.dCrop ///
c.CRPXlcc2#c.dCRP c.CRPXlcc3#c.dCRP c.CRPXlcc4#c.dCRP, robust cluster(fips)
outreg2 using "`dir'regs_2021-12-01_unweighted_cropcrp_lcc.xls", e(r2_a) stats(coef se) bdec(8) ///
