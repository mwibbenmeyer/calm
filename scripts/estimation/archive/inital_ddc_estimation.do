...
local dir "results\initial_estimation\regs_2021-09\"
capture mkdir `dir'
log using "`dir'regs_2021-09-16_weighted.log", replace
...
use in year t-5, it adjusts 2015 CCPs from 3-year to 5-year probabilities, and it replaces zero CCPs with 
minimum CCPs. */

foreach i_use in crop forest other {
	foreach f_use in crop forest other urban {
...
foreach i_use in crop forest other urban {
	foreach f_use in crop forest other urban {
