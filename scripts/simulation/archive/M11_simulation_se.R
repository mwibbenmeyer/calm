...
simulate_luc <- function(returns, estimates) {
  ...
  qui do "scripts/simulation/merge_crp_and_others/program_calc_phats_lcc.do"
...
se_fips <- cdlTools::fips(c("AR","AL","FL","GA","VA","LA","TX","MS","NC","SC","TN")) %>% 
...
est <- "results\\initial_estimation\\regs_2022-06\\regs_2022-06-21_lcc_st_se.est"
