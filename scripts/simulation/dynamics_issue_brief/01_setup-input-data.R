...
write.csv(df, sprintf("%ssim_df_crprev_urbannrsub_daveforestnr.csv",input_path))
...
write.csv(returns, sprintf("%sreturns_crprev_urbannrsub_daveforestnr.csv",input_path))
